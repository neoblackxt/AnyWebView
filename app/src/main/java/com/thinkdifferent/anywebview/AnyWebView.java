...
public class AnyWebView extends BaseXposedHookLoadPackage {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) {
        ...
        if (lpparam.packageName.equals("android")) {
            ...
            Class<?> classSystemInterface = initialize.getClassSystemInterface();
            ...
            findAndHookMethod(classWebViewUpdater, "providerHasValidSignature", classWebViewProviderInfo, PackageInfo.class, classSystemInterface, new XC_MethodHook() {
                @Override
                protected void beforeHookedMethod(MethodHookParam param) {
    ...
    private static class Initialize {
        ...
        private Class<?> classSystemInterface;
        ...
        public Class<?> getClassSystemInterface() {
            return classSystemInterface;
        }
        ...
        public Initialize invoke() {
            ...
            webViewProviders = Array.newInstance(classWebViewProviderInfo, 8);
            try {
                //Array.set(webViewProviders,0,constructorWebViewProviderInfo.newInstance("com.android.chrome", "Chrome Stable", true, false, new String[]{""}));
                Array.set(webViewProviders, 0, constructorWebViewProviderInfo.newInstance("com.android.chrome", "Chrome Stable", true, false, new String[0]));
                ...
                Array.set(webViewProviders, 1, constructorWebViewProviderInfo.newInstance("com.google.android.webview", "Google WebView", true, false, new String[0]));
                ...
                Array.set(webViewProviders, 2, constructorWebViewProviderInfo.newInstance("com.chrome.beta", "Chrome Beta", false, false, new String[0]));
                ...
                Array.set(webViewProviders, 3, constructorWebViewProviderInfo.newInstance("com.chrome.dev", "Chrome Dev", false, false, new String[0]));
                ...
                Array.set(webViewProviders, 4, constructorWebViewProviderInfo.newInstance("com.chrome.canary", "Chrome Canary", false, false, new String[0]));
                //No Signature
                Array.set(webViewProviders, 5, constructorWebViewProviderInfo.newInstance("com.google.android.apps.chrome", "Chrome Debug", false, false, new String[0]));
                ...
                Array.set(webViewProviders, 6, constructorWebViewProviderInfo.newInstance("com.android.webview", "Android System WebView", false, false, new String[0]));
                ...
                Array.set(webViewProviders, 7, constructorWebViewProviderInfo.newInstance("org.bromite.webview", "Bromite System WebView", false, false, new String[0]));
            ...
            classSystemInterface = findClass("com.android.server.webkit.SystemInterface", lpparam.classLoader);
            return this;
        }
    }
}
